...
const Dashboard = () =>{
    return(
       ...
       <div className="h-[95vh] w-[82vw] flex justify-start items-end">
       <div className="flex">
       <div className="h-[40vh] w-[30vw] mr-2 bg-gray-200 rounded flex flex-col">
        <p className="font-semibold m-3 text-3xl">Visits In<span className="text-gray-500 mx-2 text-lg">Last 30 days</span></p>
        <p className="text-5xl font-bold">1551</p>
        ...
        <div className="h-[40vh] mx-2 w-[30vw] bg-gray-200 flex flex-col rounded">
    ...
    <div className="flex">
      ...
      <CircularProgress style={{color:"rgb(0, 153, 69)"}} size="10rem" variant="determinate" value={75} />
    </Stack>
        </div>
